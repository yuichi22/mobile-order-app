    ...
    <div className="mt-5 space-y-5">
      <div className="rounded-3xl border border-slate-200 bg-white p-6">
        ...
        <ol className="mt-3 space-y-2 text-sm font-bold leading-relaxed text-slate-600">
          ...
          <li>2. 売場ごとに在庫をスキャンしてカウントすると、その場で確定します。</li>
          <li>3. 確定後は、営業中の販売分が自動でバックグラウンドで反映されていきます。</li>
          <li>4. 確定の直後(1時間以内)に売れた商品は「数え直しリスト」に入るので、もう一度数えてください。</li>
          <li>5. 品出しで倉庫から売場へ商品を移動した場合は、端末から入庫数を入力してください。</li>
